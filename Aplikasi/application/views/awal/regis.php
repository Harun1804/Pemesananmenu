<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i>Halaman Registrasi</h4>
        <div class="form-panel">
            <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="<?= site_url('welcome/p_regis');?>">
