        ...
        <header class="header black-bg">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?= site_url('admin/admin/logout'); ?>">Logout</a></li>
                </ul>
            </div>
        </header>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="mt">
                        <a class="active" href="<?= site_url('admin/admin'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="mt">
                        <a href="<?= site_url('admin/admin_user/'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Kelola User</span>
                        </a>
                    </li>
                    <li class="mt">
                        <a href="<?= site_url('admin/admin_menu/'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Kelola Menu</span>
                        </a>
                    </li>
                    <li class="mt">
                        <a href="<?= site_url('admin/admin_pemesanan');?>">
                            <i class="fa fa-dashboard"></i>
