        ...
        <header class="header black-bg">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?= site_url('welcome/regis'); ?>">Registrasi</a></li>
                    <li><a class="logout" href="<?= site_url('welcome/login'); ?>">Login</a></li>
                </ul>
            </div>
        </header>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <h5 class="centered">NorthWood Cafe</h5>
                    <li class="mt">
                        <a class="active" href="<?= site_url('Welcome'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="mt">
                        <a href="<?= site_url('Welcome/dafmen'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Daftar Menu</span>
                        </a>
                    </li>
                    <li class="mt">
                        <a href="<?= site_url('Welcome/kontak'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Kontak</span>
                        </a>
                    </li>
